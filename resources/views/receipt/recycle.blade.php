...
@section("title", "Recycling und Entsorgung")
...
.delta-ware-reason{
    ...
    <div class="main-container pt-2 pb-2">
        <h5 class="page-title">
            <span class="bold-text">Recycling und Entsorgung</span>
        </h5>
        <div class="input-wrapper">
            ...
            <div class="input-box-hide">
                <select id="reason" >
                    <option value="5" selected="selected">Recycle</option>
                </select>
            </div>
		</div>
        <div class="input-box mb-2" id="umbuchungen_option">
                <div class="radioWrapper">
                    <div class="radiocontainer radiocontainer_1">
                        <h4>Recylcen und Entsorgen von Lager</h4>
                        <div class="radio_field">
                            <input type="radio" id="test1" name="radio-group_1" value="131" >
                            <label for="test1">Lager Hamburg</label>
                        </div>
                        <div class="radio_field">
                            <input type="radio" id="test2" name="radio-group_1" value="132" checked>
                    ...
                    <div class="radiocontainer radiocontainer_2">
                        <h4>nach...</h4>
                        <div class="radio_field">
                            <input type="radio" id="test7" name="radio-group_2" value="999" checked>
                            <label for="test7">Endstation Mülleimer</label>
                        </div>
                        <!-- <div class="radio_field">
