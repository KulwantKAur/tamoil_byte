...
@section("title", "Laden Bestückung")
...
<div class="main-container pt-2 pb-2">
    <h5 class="page-title">
        <span class="bold-text">O N O M A O - LADEN BESTÜCKUNG</span> {{Session::get('count')}} von {{Session::get('total_count')}}</br>
    </h5>
        ...
        <div>
            <table style="width:100%">
                ...
                <!-- Append company name below barcode   
                    ...
                    @if($order->shippingProviderProductId == '209113' || $order->shippingProviderProductId == '287342')
