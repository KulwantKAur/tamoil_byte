...
@section("content")
    <div class="main-container pt-2 pd-2" id="invoice">
        <div class="input-box quality">
            ...
            <input id="scan" type="text" class="d-block"  autofocus oninput="handleChangeInvoiceNumber(event)">
		...
		{{-- <a href="/multibox">
            <button class="btn btn-warning text-dark mr-3">Mehrpaket Sendung</button>
        </a> --}}
    </div>
@endsection
